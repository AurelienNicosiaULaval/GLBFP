...
A list with class `c("glbfp_grid", "GLBFP_estimate")` containing grid
...
- `print(GLBFP_estimate)`: Print method for object of class
  `"GLBFP_estimate"`.

- `plot(GLBFP_estimate)`: Plot method for object of class
  `"GLBFP_estimate"`.
