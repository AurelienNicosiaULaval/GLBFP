# Contributing to GLBFP

Thank you for considering contributing to **GLBFP**! 🎉 We welcome all
contributions, whether it’s fixing a bug, improving documentation, or
adding new features.
...
Click the **Fork** button at the top right of this repository to create
a copy of it in your GitHub account.
...
Go to [the original
repository](https://github.com/AurelienNicosiaULaval/GLBFP) and click on
**New Pull Request**. Select your fork and branch, and describe your
changes.
...
on [GitHub
Issues](https://github.com/AurelienNicosiaULaval/GLBFP/issues).
